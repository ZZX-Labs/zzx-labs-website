// __partials/widgets/nodes-by-city/js/viewport.js
(function(){
  "use strict";

  const W=window;
  if(Number(W.ZZXNodesByCityViewport?.__version||0)>=4)return;
  ...
  W.ZZXNodesByCityViewport=Object.freeze({
    __version:4,
    attach
  });
})();
