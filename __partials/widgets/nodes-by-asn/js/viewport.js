// __partials/widgets/nodes-by-asn/js/viewport.js
(function(){
  "use strict";

  const W=window;
  if(Number(W.ZZXNodesByAsnViewport?.__version||0)>=2)return;
  ...
  W.ZZXNodesByAsnViewport=Object.freeze({
    __version:2,
    attach
  });
})();
