// __partials/widgets/node-latency/js/provider.js
(function(){
  "use strict";

  const W=window;
  if(Number(W.ZZXNodeLatencyProvider?.__version||0)>=2)return;
  ...
  async function load(force=false){
    ...
    return Object.freeze({
      detail,
      model:W.ZZXNodeLatencyModel.build(detail.snapshot)
    });
  }

  W.ZZXNodeLatencyProvider=Object.freeze({
    __version:2,
    load
  });
})();
