(function(){
  ...
  function migrate(){
    ...
    // Preserve the old checked-checkbox behavior: checked meant the
    // Global BPI was volume weighted. Explicit false migrates to OFF.
    return legacy==="false"?"off":"global-bpi";
  }
