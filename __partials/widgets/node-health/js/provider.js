// __partials/widgets/node-health/js/provider.js
(function(){
  "use strict";

  const W=window;
  if(Number(W.ZZXNodeHealthProvider?.__version||0)>=2)return;
  ...
  async function load(force=false){
    ...
    return Object.freeze({
      detail,
      model:W.ZZXNodeHealthModel.build(detail.snapshot)
    });
  }

  W.ZZXNodeHealthProvider=Object.freeze({
    __version:2,
    load
  });
})();
