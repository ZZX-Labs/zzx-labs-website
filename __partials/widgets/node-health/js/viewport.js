// __partials/widgets/node-health/js/viewport.js
(function(){
  "use strict";

  const W=window;
  if(Number(W.ZZXNodeHealthViewport?.__version||0)>=2)return;
  ...
  W.ZZXNodeHealthViewport=Object.freeze({
    __version:2,
    attach
  });
})();
