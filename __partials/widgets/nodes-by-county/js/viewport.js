// __partials/widgets/nodes-by-county/js/viewport.js
(function(){
  "use strict";

  const W=window;
  if(Number(W.ZZXNodesByCountyViewport?.__version||0)>=4)return;
  ...
  W.ZZXNodesByCountyViewport=Object.freeze({
    __version:4,
    attach
  });
})();
