...
(function(){
  ...
  function websocketUrls(core){
     ...
     * stream instead of leaving Mosaic stuck on a ten-transaction recent sample.
     */
    return [...new Set([
      ...configured,
      websocketUrl(base),
  ...
  function get(core){
    ...
    return {
      ...
      endpoints:{
        ...
        txStatus:join(base,"tx/{txid}/status"),
        txOutspends:join(base,"tx/{txid}/outspends"),
        txMerkleProof:join(base,"tx/{txid}/merkle-proof"),
