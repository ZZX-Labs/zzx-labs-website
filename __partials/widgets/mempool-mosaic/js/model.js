(function(){
  "use strict";
  const W=window;
  if(W.ZZXMempoolMosaicModel?.__version>=2)return;
  ...
  function build(payload){
    ...
    const maxTiles=W.ZZXMempoolMosaicSources?.maxTiles||6000;
    ...
    if(!(candidateVbytes>0))candidateVbytes=W.ZZXMempoolMosaicSources?.candidateVbytes||1_000_000;
    ...
    return Object.freeze({
      schema:"zzx-mempool-mosaic-model-v2",
      mode,
      tipHeight,
      nextHeight,
      candidateVbytes,
