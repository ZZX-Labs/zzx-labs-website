...
## CEX model
The CEX centralizes order admission, sequencing, price-time matching, market data, compliance state, and surveillance, but not custody.

## Matching boundary
Accepted order intents are centrally sequenced and hash-committed. The matcher can create trades but cannot spend user Bitcoin.
...
## Nation scope
This is the official FreedomX United States port. Other countries require separately reviewed local ports if they want FreedomX certification. “Official” means project-network approval only, not government endorsement.
