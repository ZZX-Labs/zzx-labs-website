...
`/projects/software/freedomkobra/freedomkobracex/`

FreedomKobraCEX is the United States CEX implementation in the FreedomX family.
...
## Exact original Kobra source snapshot

`research/original/freedomkobracex-0.1.0-alpha/` contains the supplied pre-FreedomX Kobra CEX package unchanged for provenance and comparison. The active `cex-research-core.js` is preserved byte-for-byte from that upload.
