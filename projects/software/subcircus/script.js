// SubCircus page boot: fetch ./manifest.json → hydrate hero, buttons, badges, gallery.
(async function () {
  ...
  try {
    ...
    addBtn("Open", m.href || "/projects/software/subcircus/");
    ...
    if (!imgs.length) {
      ...
      imgs.forEach((src) => addImg(src, m.title || "SubCircus"));
