// Vishal page boot: fetch ./manifest.json → hydrate hero, buttons, badges, gallery.
(async function () {
  ...
  try {
    ...
    // buttons
    addBtn("Open", m.href || "/projects/software/vishal/");
    ...
    if (!imgs.length) {
      ...
      imgs.forEach((src) => addImg(src, m.title || "Vishal"));
