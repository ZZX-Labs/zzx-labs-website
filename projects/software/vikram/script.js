// Vikram page boot: fetch ./manifest.json → hydrate hero, buttons, badges, gallery (if any).
(async function () {
  ...
  try {
    ...
    // buttons
    addBtn("Open", m.href || "/projects/software/vikram/");
    ...
    if (!imgs.length) {
      ...
      imgs.forEach((src) => addImg(src, m.title || "Vikram"));
